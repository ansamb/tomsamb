<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="ProductsForSupplierDetails.aspx.cs" Inherits="Inżynierka.Results3" %>
<asp:Content ID="Content1" ContentPlaceHolderID="HeadContent" runat="server">
</asp:Content>
<asp:Content ID="Content2" ContentPlaceHolderID="FeaturedContent" runat="server">
    <<%--div class="onb_summaryHead">
        <asp:GridView ID="GridView3" runat="server"></asp:GridView>--%>
                    <%--<h1><span class="icon-onb_eye iconM"  ></span>Podsumowanie</h1>
                                    <p>Bilet(y) = </p>
                                    <p>Opłata rezerwacyjna = </p>
                                    <h2>Cena całkowita = </h2>
      </div>--%>
...
<%--     <asp:label id="PostedLabel " 
     ...
     <%--SelectCommand="SELECT [Data], [MiastoWylotu], [MiastoPrzylotu], [Cena], [Linia], [GodzinaWylotu], [GodzinaPrzylotu]--%>
